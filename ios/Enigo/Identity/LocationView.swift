...
struct LocationView: View {
    ...
    var body: some View {
        EnigoScreen {
            ...
            Text("Optional. Pen pals can be anywhere — that's the point of writing. If you'd rather keep it closer, share a rough location and pick a distance. Your area stays sealed until it unlocks for them, and it's never an address.")
                .font(EnigoFont.body)
